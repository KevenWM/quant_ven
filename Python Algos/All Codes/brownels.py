...
url = 'https://www.brownells.com/firearms/handguns/index.htm'
...
today = date.today()
df.to_csv(f'C:/Users/rafael.furtado/PycharmProjects/gunspricemonitor/data/brownellsmonitorprice' + str(today) + '.csv', encoding='utf-8', sep=';')
